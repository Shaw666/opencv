...
def get_opt():
    ...
    parser.add_argument('--xml_path', default=annotations_path, type=str, help='input xml file ')
    parser.add_argument('--txt_path', default=save_txt_path, type=str, help='output txt file')
